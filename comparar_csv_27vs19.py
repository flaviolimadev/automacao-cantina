...
e identificar quais estão no arquivo mais recente (27/07) mas não no anterior (19/07)
"""
...
def main():
    ...
    arquivo_27julho = "responsaveis_com_dividas_20250727_135730.csv"
    ...
    if responsaveis_novos:
        ...
        arquivo_saida = f"responsaveis_novos_27vs19_{timestamp}.csv"
